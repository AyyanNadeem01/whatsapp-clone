...
//   // Fix 1: Filter out any contacts that don't have a username to prevent errors.
...
//             className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:outline-non focus:ring-2 focus:ring-green-500 ${
//               theme === "dark"
...
//         {/* Fix 2: Add a check to ensure filteredContacts is a valid array before mapping. */}
...
//             >
//               <img
//                 // Fix 3: Use a fallback image if profilePicture is missing.
//                 src={contact?.profilePicture || 'https://api.dicebear.com/6.x/avataaars/svg?seed=placeholder'}
...
//                     {/* Fix 4: Safely access username. It's now guaranteed to exist due to the filter. */}
//                     {contact.username}
//                   </h2>
              ...
              <div className="ml-3 flex-1">
                <div className="flex justify-between items-baseline">
                  ...
                  {contact?.conversation?.lastMessage?.createdAt && (
                    ...
                    >
                      {formatTimeStamp(contact.conversation.lastMessage.createdAt, now)}
                    </span>
                  )}
                </div>
                <div className="flex justify-between items-baseline">
