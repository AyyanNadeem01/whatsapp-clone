...
//             Choosa a Contact from the list on the left begin messaging
//           </p>
...
  messageEndRef.current?.scrollIntoView({ behavior: "smooth" });
  ...
  //Group message
  const groupedMessage = Array.isArray(messages)
      ...
      <div className={`p-4 ${theme==="dark"? "bg-[#303430] text-white" : 
        ...
        {isTyping? (
          ...
          <p className={`text-sm ${theme==="dark"? "text-gray-400":"text-gray-500"}`}>
            {online?"Online": lastSeen?`LastSeen ${format(new Date(lastSeen),"HH:mm")}`:"Offline"}
          </p>
        )}
        </div>
