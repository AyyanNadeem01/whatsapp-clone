...
//                 <div
//                 key={index}
//                 className='h-1 bg-gray-400 bg-opacity-50
//                  flex-1 rounded-full overflow-hidden'>
//                   <div
//                   className='h-full bg-white transition-all duration-100
//                   ease-linear rounded-full'
//                   style={{width:index<currentIndex?"100%":
...
//             </div>
//             <div
//             className='absolute top-0 left-4 right-16 z-10
...
//              >{formatTimestamp(currentStatus.timestamp)}</p>
//            </div>
//               </div>
